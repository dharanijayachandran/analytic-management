...
@Component({
  selector: 'app-direction-map-form',
  templateUrl: './direction-map-form.component.html',
  styleUrls: ['./direction-map-form.component.css']
})
export class DirectionMapFormComponent implements OnInit {
  ...
  ngAfterViewInit() {
    ...
    this.dashboardWidgetPostion = document.getElementById(id).style.transform;
  ...
  getDataServiceParamOnUpdate(event: Event) {
