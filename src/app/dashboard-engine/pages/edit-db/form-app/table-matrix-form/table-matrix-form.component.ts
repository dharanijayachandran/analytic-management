...
@Component({
  selector: 'app-table-matrix-form',
  templateUrl: './table-matrix-form.component.html',
  styleUrls: ['./table-matrix-form.component.css']
})
export class TableMatrixFormComponent implements OnInit {
  ...
  ngOnInit() {
    this.getChartColorByWidgetCode(39);
