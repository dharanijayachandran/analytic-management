...
@Component({
  ...
  templateUrl: './pie-chart-form.component.html',
  styleUrls: ['./pie-chart-form.component.css']
})
export class PieChartFormComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    //{
    //this.getDataSourceFormOnUpdate(this.inputParams);
    //}
  }
