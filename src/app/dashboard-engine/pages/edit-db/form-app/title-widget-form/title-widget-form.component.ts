...
@Component({
  selector: 'app-title-widget-form',
  templateUrl: './title-widget-form.component.html',
  styleUrls: ['./title-widget-form.component.css']
})
export class TitleWidgetFormComponent implements OnInit {
